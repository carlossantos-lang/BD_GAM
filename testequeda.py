...
Original file is located at
    https://colab.research.google.com/drive/1v2AAhEKRn8Tw49jiczDZrIrpy478TW1_
"""
    ...
    for row in data:
        ...
        if any(
            ...
            try:
                ...
                revenue_fmt = f"{revenue:.2f}".replace(".", ",")
                ...
                all_rows.append(
                    [
                        ...
                        row.get("Column.AD_EXCHANGE_TOTAL_REQUESTS", 0),
                        row.get("Column.AD_EXCHANGE_LINE_ITEM_LEVEL_CLICKS", 0),
                    ]
                )
            except Exception as e:
